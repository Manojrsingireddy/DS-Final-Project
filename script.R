...
### Student Names: Manoj Singireddy, Pranav Mereddy, Surya Chokkar, Cameron Wee
##############################################################
...
### Read in Data
fake <- read.csv("/Users/manojsingireddy/Documents/Data Science/DS-Final-Project/fake_job_postings.csv") #Adjust for your computer
